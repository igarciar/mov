...
// workMode
#define kFindMode                               0x00
#define kWarnMode                               0x01
#define kLostAlarmMode                          0x02
...
/*
// 发送消息
#define nRxRssi                                 [[NSNotificationCenter defaultCenter]postNotificationName:@"CBRxRssi" object:nil];
#define nTxRssi                                 [[NSNotificationCenter defaultCenter]postNotificationName:@"CBTxRssi" object:nil];
#define nPeripheralStateChange                  [[NSNotificationCenter defaultCenter]postNotificationName:@"CBcurrentPeripheralStateChange"  object:nil];
#define nConnectedFinish                        [[NSNotificationCenter defaultCenter]postNotificationName:@"CBConnectedFinish"  object:nil];
#define nAutoSetupToggleAlarmValue              [[NSNotificationCenter defaultCenter]postNotificationName:@"CBAutoSetupToggleAlarmValue"  object:nil];


// 接收消息
#define nCBRxRssi                               [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CBRxRssi) name:@"CBRxRssi" object:nil];
#define nCBTxRssi                               [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CBTxRssi) name:@"CBTxRssi" object:nil];
#define nCBPeripheralStateChange                [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CBcurrentPeripheralStateChange) name:@"CBcurrentPeripheralStateChange" object:nil];
#define nCBConnectedFinish                      [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CBConnectedFinish) name:@"CBConnectedFinish" object:nil];
#define nCBAutoSetupToggleAlarmValue            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(CBAutoSetupToggleAlarmValue) name:@"CBAutoSetupToggleAlarmValue" object:nil];
*/
//==============================================
// 发送消息
...
// 定义报警声音
//==============================================
#define audioArray                              [[NSArray alloc] initWithObjects:@"dgjd", @"bjs", @"BeatPlucker", @"Bollywood", @"LeisureTime", @"LoveFlute", @"Orange", @"Simple_World", @"Third_Eye", @"World", @"belove", @"music01", @"music02", @"music03", @"music04", @"dzjb",@"Error", @"119jd", @"jlyx", @"ls", @"Alarm_Beep_01", @"Alarm_Beep_02", @"Alarm_Rooster_02", @"Alarm_Classic", @"Alarm_Buzzer", @"Finish", @"pixiedust", nil]

#define audioName                               [[NSArray alloc] initWithObjects:@"Dj alarm", @"Alarm", @"BeatPlucker", @"Bollywood", @"LeisureTime", @"LoveFlute", @"Orange", @"Simple_World", @"Third_Eye", @"World", @"Belove", @"Cool music01", @"Cool music02", @"Cool music03", @"Cool music04", @"Electronic alarms",@"Error", @"Fire alarm", @"Ambulance alarm", @"Thunder", @"Beep01", @"Beep02", @"Rooster", @"Classic", @"Buzzer", @"Finish", @"Pixiedust", nil]
//==============================================
...
#define InitDisconnectPlayer                    disconnectPlayer = [self setPlayer:keyPlayer AtIndex:16 WithLoop:3];
...
//-(void)setEnabelAntilostWork:(Byte)antilostWork;
