...
#define firstCellHeight               120
#define  firstCell                    0
#define secondCell                    1
#define thirdCell                     2
#define fourthCell                    3
#define widthCell                     280
...
- (void)viewDidLoad
{
    ...
    _backProgress = [UIProgressView new];
...
-(void)CBTxRssi{
    ...
    //NSLog(@"progressValue:%f currentPeripheral.TxFilteringValue:%d",progressValue, _currentPeripheral.TxFilteringValue);
}
